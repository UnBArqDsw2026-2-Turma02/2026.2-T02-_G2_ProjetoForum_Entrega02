...
<img src="Base/Relatórios/assets/DiagramaPacotesMVC.png" alt="Diagrama de Pacotes — subdomínio Conteúdo (MVC) — v1.0" width="100%">
...
##### Referências — Diagrama de Pacotes
* UML-DIAGRAMS.ORG. **Package Diagrams Overview**. Disponível em: [https://www.uml-diagrams.org/package-diagrams-overview.html](https://www.uml-diagrams.org/package-diagrams-overview.html). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **UML Package**. Disponível em: [https://www.uml-diagrams.org/package-diagrams.html#package](https://www.uml-diagrams.org/package-diagrams.html#package). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **Package Template**. Disponível em: [https://www.uml-diagrams.org/package-diagrams.html#package-template](https://www.uml-diagrams.org/package-diagrams.html#package-template). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **Package Diagram Examples**. Disponível em: [https://www.uml-diagrams.org/package-diagrams-examples.html](https://www.uml-diagrams.org/package-diagrams-examples.html). Acesso em: 18 set. 2026.
...
##### Referências — Diagrama de Classes
* UML-DIAGRAMS.ORG. **Class Diagrams Overview**. Disponível em: [https://www.uml-diagrams.org/class-diagrams-overview.html](https://www.uml-diagrams.org/class-diagrams-overview.html). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **Association in UML Class Diagrams**. Disponível em: [https://www.uml-diagrams.org/association.html?context=class-diagrams](https://www.uml-diagrams.org/association.html?context=class-diagrams). Acesso em: 18 set. 2026.
* DEVMEDIA. **Orientações básicas na elaboração de um diagrama de classes**. Disponível em: [https://www.devmedia.com.br/orientacoes-basicas-na-elaboracao-de-um-diagrama-de-classes/37224](https://www.devmedia.com.br/orientacoes-basicas-na-elaboracao-de-um-diagrama-de-classes/37224). Acesso em: 18 set. 2026.
...
> 💡 *Dica: Para explorar todos os detalhes com zoom interativo (`Ctrl + Scroll` do mouse) e navegação livre, utilize o link abaixo para abrir o diagrama vetorial em uma aba dedicada:*  
> 🔍 **[Abrir Diagrama de Sequência em Alta Resolução em Nova Aba](Base/Relatórios/assets/DiagramaSequenciaAds.svg ':target=_blank')**
...
<a href="Base/Relatórios/assets/DiagramaSequenciaAds.svg" target="_blank" title="Clique para abrir o diagrama em alta resolução em nova aba">
  <img src="Base/Relatórios/assets/DiagramaSequenciaAds.svg" alt="Diagrama de Sequência — Módulo de Ads (UML) — v1.0" width="100%">
</a>
...
##### Referências — Diagrama de Sequência
* UML-DIAGRAMS.ORG. **Sequence Diagrams Overview**. Disponível em: [https://www.uml-diagrams.org/sequence-diagrams.html](https://www.uml-diagrams.org/sequence-diagrams.html). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **Interaction Message**. Disponível em: [https://www.uml-diagrams.org/interaction-message.html](https://www.uml-diagrams.org/interaction-message.html). Acesso em: 18 set. 2026.
* UML-DIAGRAMS.ORG. **Sequence Diagrams Examples**. Disponível em: [https://www.uml-diagrams.org/sequence-diagrams-examples.html](https://www.uml-diagrams.org/sequence-diagrams-examples.html). Acesso em: 18 set. 2026.
...
| Pedro Vargas | Nesta entrega, aprendi bastante sobre o conteúdo da disciplina, especialmente na diferença de modelagem estática e dinâmica e como elas se complementam. Ao relaizar os diagramas UML, ficou claro o rigor exigido em conceitos arquiteturais como agregações, composições e multiplicidades, e como um diagrama de classes bem construído garante a estabilidade do sistema. Aprendi que a modelagem UML não é somente um artefato meio que genérico, mas sim uma tradução das regras de negócio e restrições do sistema para uma notação formal mais técnica para documentar e comunicar a arquitetura. | Diferente de usar a IA apenas para gerar rascunhos iniciais, utilizei a IA generativa como uma parceira de revisão técnica. Com o apoio da ferramenta, conduzi auditorias rigorosas nos nossos modelos UML, o que me ajudou profundamente a entender na prática como funcionam os diagramas e suas notações formais (agregações e multiplicidades). O maior aprendizado foi conseguir equilibrar a IA com a revisão humana: a ferramenta tende a alucinar detalhes e errar notações se não for muito bem instruída. Ela entrega muito valor para explicar conceitos e apontar inconsistências, mas o direcionamento humano é essencial para não aceitar um modelo formalmente incorreto. |
...
| Pedro Vargas | Atualização do Diagrama de Classes UML | 18/09/2026 | [Ver seção](https://unbarqdsw2026-2-turma02.github.io/2026.2-T02-_G2_ProjetoForum_Entrega02/#/Base/Relatórios/1.1.3.SubEquipe_03?id=diagrama-de-classes--módulo-de-ads) |
| Pedro Vargas | Adiciona referências bibliográficas da literatura e fontes aos diagramas do Foco 01 e Foco 02 | 18/09/2026 | [Ver página](https://unbarqdsw2026-2-turma02.github.io/2026.2-T02-_G2_ProjetoForum_Entrega02/#/Base/Relatórios/1.1.3.SubEquipe_03) |
