...
> 🔍 **[Abrir Diagrama de Classes em Alta Resolução em Nova Aba](./assets/diagrama-classes-ads.svg ':target=_blank')**
...
<a href="Base/Relatórios/assets/diagrama-classes-ads.svg" target="_blank" title="Clique para abrir o diagrama em alta resolução em nova aba">
  <img src="./assets/diagrama-classes-ads.svg" alt="Diagrama de Classes do módulo de Ads (UML)" width="100%">
</a>
